...
function out = runMatchingFrameworkOnGivenData(data, iUAVs, iCams, frameworkWinSize, dims, cropToMinT, maxExperimentTime)
	...
	if nargin<4 || isempty(frameworkWinSize)
		frameworkWinSize = [25, 50, 75, 100, 250]; % [15:15:300 10000];
	end
